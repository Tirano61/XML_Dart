...
class XMLvariables{
  ...
  static abrirTabla(int expandedColumnCount, int rowCount){
    final String abrirTabla = "<Table ss:ExpandedColumnCount=\"$expandedColumnCount\" ss:ExpandedRowCount=\"$rowCount\" x:FullColumns=\"1\"\n" 
  ...
  static crearEncabezado(List<String> nombres){
    ...
    String encabezado = "<Row ss:AutoFitHeight=\"0\">\n" 
                      ...
                      "      ss:Type=\"String\">Hacienda</Data></Cell>\n" 
                      "   </Row>\n" 
